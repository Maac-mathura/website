      ...
      <div className="footer-links">
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><a href="/WebGraphicPage">Web and Graphic Design</a></li>
            <li><a href="/ShortTermSpecializedPage">Short Term</a></li>
            <li><a href="/MoreCareerCoursesPage">More Courses</a></li>
          </ul>
        </div>
        <div className="footer-column">
          <h3>Contact Us</h3>
